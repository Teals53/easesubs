...
export default function DashboardClient() {
  ...
  const { data: recentActivity, isLoading: activityLoading } =
    trpc.user.getRecentActivity.useQuery(undefined, {
      enabled: !!session,
    });
          ...
          {statsLoading ? (
            <div className="space-y-4">
              {Array.from({ length: 3 }).map((_, i) => (
                <div
                  key={i}
                  className="animate-pulse flex items-center p-3 lg:p-4 bg-gray-700/30 rounded-lg"
                >
            ...
            <div className="space-y-4">
              {dashboardStats.recentOrders.map((order) => (
                <div
                  key={order.id}
                  className="flex items-center justify-between p-3 lg:p-4 bg-gray-700/30 rounded-lg hover:bg-gray-700/50 transition-colors"
                >
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3 lg:gap-4">
            ...
            >
              ...
              <p className="text-white font-medium text-sm lg:text-base mb-1">
                Checkout
              </p>
