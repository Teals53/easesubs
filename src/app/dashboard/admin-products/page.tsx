...
export default function AdminProductsPage() {
  ...
  const { data: categories, refetch: refetchCategories } = trpc.admin.getCategories.useQuery(undefined, {
    enabled: isAdmin,
  });
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      {product.plans[0].originalPrice && (
                        <span className="text-gray-400 line-through text-sm">
                          {formatPrice(Number(product.plans[0].originalPrice))}
                        </span>
                      )}
                    </div>
                  )}
...
function CategoriesTab({ 
  ...
  const toggleCategoryStatusMutation = trpc.admin.toggleCategoryStatus.useMutation({
    onSuccess: () => {
      refetch();
      utils.admin.getCategories.invalidate();
      utils.product.getCategories.invalidate();
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex space-x-2">
                ...
                <button
                  ...
                  disabled={deleteCategoryMutation.isPending || category.count > 0}
                  className="p-2 bg-red-600 hover:bg-red-700 disabled:bg-red-600/50 rounded-lg transition-colors"
