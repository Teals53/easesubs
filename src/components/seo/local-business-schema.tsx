    ...
    "review": [
      {
        ...
        "reviewBody": "Amazing service! Saved over 60% on my Netflix and Spotify subscriptions. Customer support is excellent and the process is very straightforward.",
      ...
      },
      {
        ...
        "reviewBody": "Been using EaseSubs for 6 months now. Great savings on Adobe Creative Cloud and other software. Highly recommend!",
...
export function SubscriptionServiceSchema() {
  const serviceSchema = {
    ...
    "description": "Legal regional pricing system for premium subscription services. Access Netflix, Spotify, Adobe Creative Cloud, and more at up to 80% off regular prices.",
    "areaServed": {
      "@type": "GeoTargeting",
      "geo": "Worldwide"
    },
...
export function SoftwareApplicationSchema({ product }: { product: {
  ...
  const softwareSchema = {
    ...
    "installUrl": "https://easesubs.com/product/" + product.name.toLowerCase().replace(/\s+/g, '-'),
    "permissions": "Access to premium features",
    "releaseNotes": "Access to latest version with all premium features included."
  };
...
export function ProductCollectionSchema({ category, products }: {
  category: string;
  products: Array<{ name: string; price: number; currency: string; description: string; }>;
}) {
