...
export default function DashboardNav() {
  ...
  const baseNavItems: NavItem[] = [
    ...
    { id: 'profile-settings', label: 'Profile & Settings', icon: User, href: '/dashboard/profile-settings' },
  ]

  const adminNavItems: NavItem[] = [
    { id: 'admin-dashboard', label: 'Admin Dashboard', icon: BarChart3, href: '/dashboard/admin-dashboard' },
    { id: 'admin-users', label: 'User Management', icon: Users, href: '/dashboard/admin-users' },
    { id: 'admin-products', label: 'Product Management', icon: Package, href: '/dashboard/admin-products' },
    { id: 'admin-orders', label: 'Order Management', icon: Package, href: '/dashboard/admin-orders' },
    { id: 'admin-support', label: 'Support Tickets', icon: Ticket, href: '/dashboard/admin-support' },
  ]
  ...
  return (
    <>
      ...
      {/* Navigation Menu */}
      <div className={`${isMobileMenuOpen ? 'block' : 'hidden'} lg:block bg-gray-900/50 backdrop-blur-lg rounded-2xl border border-gray-700/50 lg:sticky lg:top-8 flex flex-col`}>
