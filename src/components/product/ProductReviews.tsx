...
import { Star, ThumbsUp, User, Calendar, Filter } from "lucide-react";
...
export default function ProductReviews({ productId }: ProductReviewsProps) {
  ...
  // Fetch reviews
  const { data: reviewsData, isLoading, fetchNextPage, hasNextPage } = 
  ...
  return (
    <div className="bg-gray-800/50 backdrop-blur-lg p-6 rounded-2xl border border-gray-700">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        {/* Rating Distribution */}
        <div>
          <h4 className="text-sm font-medium text-gray-400 mb-3">Rating Distribution</h4>
