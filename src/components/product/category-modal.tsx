...
import { X, Save, Palette, Type, FileText, Hash, ToggleLeft, ToggleRight } from "lucide-react";
...
export function CategoryModal({
  ...
  const iconOptions = [
    "Package", "Tag", "Grid", "List", "Star", "Heart",
    "Play", "Music", "Image", "Video", "BookOpen", "Gamepad2",
    "Zap", "Tool", "Palette", "Code", "Database", "Server",
    "Globe", "Building2", "Users", "MessageCircle", "Mail", "Phone"
  ];
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <motion.div
          ...
          className="relative w-full max-w-2xl mx-4 bg-gray-900 rounded-2xl border border-gray-700 shadow-2xl"
        >
          {/* Header */}
