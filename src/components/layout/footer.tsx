          ...
          <div className="md:col-span-1">
            ...
            <div className="flex items-center space-x-3 sm:space-x-3">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="p-3 sm:p-2 bg-gray-800 hover:bg-blue-500 rounded-lg transition-colors group"
              >
                <Twitter className="w-5 h-5 sm:w-4 sm:h-4 text-gray-400 group-hover:text-white" />
              </motion.a>
              <motion.a
                ...
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.95 }}
                className="p-3 sm:p-2 bg-gray-800 hover:bg-black rounded-lg transition-colors group"
              >
                <svg
                  className="w-5 h-5 sm:w-4 sm:h-4 text-gray-400 group-hover:text-white"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.95 }}
                className="p-3 sm:p-2 bg-gray-800 hover:bg-pink-500 rounded-lg transition-colors group"
              >
                <svg
                  className="w-5 h-5 sm:w-4 sm:h-4 text-gray-400 group-hover:text-white"
                  viewBox="0 0 24 24"
